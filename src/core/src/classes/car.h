...
//#include "core/srv/pick_release.hpp"
...
private:
    ...
    //rclcpp::Service<core::srv::PickRelease>::SharedPtr pick_release_service;
    ...
    //void handle_pick_release(const std::shared_ptr<core::srv::PickRelease::Request> out_req, std::shared_ptr<core::srv::PickRelease::Response> response);
};
#endif
